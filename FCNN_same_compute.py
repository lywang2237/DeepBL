...
# hidden dims for FC-NN-COMP is 331 (see supporting information of manuscript)
hidden_dims = 331
leaky_alpha = 0.3
batch_size = 512
epoch = 200
...
model_full_path = '/nn_model/model_same_compute_1.h5'
...
# model structure for FC-NN-COMP, which has 10 layers
model = Sequential()
...
print('same compute complete model training!')
