# training for 1D-CNN on nonlinearly transformed data
...
# you can change the data_path for different nonlinear transformation data (from 0.3 to 0.9)
# you can change the number in model_full_path to get different model
data_path = '/nn_data/nonli_trans/0.6/'
model_full_path = '/nn_model/model_nonli_0.6_1.h5'
